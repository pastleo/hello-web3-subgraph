...
export class Greeted extends ethereum.Event {
  get params(): Greeted__Params {
    return new Greeted__Params(this);
  }
}

export class Greeted__Params {
  _event: Greeted;

  constructor(event: Greeted) {
    this._event = event;
  }
